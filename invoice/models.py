...
class Invoice(models.Model):
    ...
    price_per_item = models.FloatField(verbose_name='Price Per Item (NGN)')
    quantity = models.FloatField(default=0.00)
    shipping = models.FloatField(verbose_name='Shipping and Handling')
    total = models.FloatField(
        verbose_name='Total Amount (NGN)', editable=False
    )
    grand_total = models.FloatField(
        verbose_name='Grand Total (NGN)', editable=False
    )
